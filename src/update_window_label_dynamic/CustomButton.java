...
public class CustomButton extends Composite {
	...
	public CustomButton(Composite parent, int style) {
		...
		this.defaultBGColor = getSavedColor(226, 226, 226);
		this.defaultFGColor = getSavedColor(0, 0, 0);
		this.defaultMouseDownBGColor = getSavedColor(153, 204, 255);
		this.defaultMouseDownFGColor = getSavedColor(153, 204, 255);
		this.defaultMouseEnterBGColor = getSavedColor(204, 229, 255);
		this.defaultMouseEnterFGColor = getSavedColor(204, 229, 255);
	...
	private void init(Composite parent) {
		...
		leftLabel = new CLabel(this, SWT.BORDER);
		rightLabel = new CLabel(this, SWT.BORDER);
	...
	/**
	 * Sets the foreground mouse enter.
	 *
	 * @param defaultMouseHoverFGColor the new foreground mouse enter
	 */
	...
	/**
	 * Sets the background mouse enter.
	 *
	 * @param defaultMouseHoverBGColor the new background mouse enter
	 */
	...
	/**
	 * Sets the foreground mouse up.
	 *
	 * @param defaultMouseUpFGColor the new foreground mouse up
	 */
	...
	/**
	 * Sets the background mouse up.
	 *
	 * @param defaultMouseUpBGColor the new background mouse up
	 */
	...
	/**
	 * Sets the foreground mouse down.
	 *
	 * @param defaultMouseDownFGColor the new foreground mouse down
	 */
	...
	/**
	 * Sets the background mouse down.
	 *
	 * @param defaultMouseDownBGColor the new background mouse down
	 */
	...
	public void setMouseEnterFont(final Font font){
		...
		this.addMouseTrackListener(new MouseTrackAdapter() {
			@Override
			public void mouseEnter(MouseEvent event) {
				mouseEnterFont(customMouseHoverFont);
			}
		});
	}
	 ...
	 * Mouse enter font.
	 *
	 * @param customMouseHoverFont the custom mouse hover font
	 */
	private void mouseEnterFont(final Font customMouseHoverFont) {
		...
		leftLabel.getParent().layout();
		leftLabel.getParent().getParent().update();
	}
	...
	public void setSelectionFont(final Font font){
		...
		this.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseDown(MouseEvent event) {
				selectionFont(customSelectionFont);
			}
		});
	}
	 ...
	 * Selection font.
	 *
	 * @param customSelectionFont the custom selection font
	 */
	private void selectionFont(final Font customSelectionFont) {
	...
	public void setImage(final Image image) {
		this.image = image;
		if(this.image != null){
			this.leftLabel.setImage(this.image);
		}
	}
